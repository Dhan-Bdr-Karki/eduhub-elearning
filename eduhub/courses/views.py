...
class ManageCourseListView(ListView):
    ...
    # preventing users from editing, updating, deleting courses they didn't create
    def get_queryset(self):
        qs = super().get_queryset()
        return qs.filter(owner=self.request.user)

# common behavior for multiple views in mixin classes
class OwnerMixin:
    def get_queryset(self):
        qs = super().get_queryset()
        return qs.filter(owner=self.request.user)
...
# updating the order of the course module after drag and drop
...
# updating the order of the module's content after drag and drop
